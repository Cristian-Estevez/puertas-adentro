...
class User extends Model {
    ...
    public function create($user) {
        $stmt = $this->db->prepare("INSERT INTO users (email, first_name, last_name, username, password, active, role, created_at, updated_at) VALUES (:email, :first_name, :last_name, :username, :password, :active, :role, :created_at, :updated_at)");
        $stmt->execute($user);
        return $stmt->fetch(PDO::FETCH_ASSOC);
    }
