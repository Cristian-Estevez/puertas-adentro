        ...
        <div class="w-full max-w-md">
            <header class="flex flex-col items-center justify-center text-center mb-8">
                <div class="flex items-center gap-3 text-gray-800 mb-4">
                    ...
                    <h1 class="text-2xl font-bold tracking-tight text-[var(--primary-blue)]">
                        Puertas Adentro
                    </h1>
                </div>
            ...
            <form method="post" action="<?= $this->url('login') ?>">
                ...
                <div id="formMsg" role="alert" aria-live="polite" class="text-sm text-gray-600"></div>

                <button type="submit" id="submitBtn"
                    class="w-full flex justify-center py-3 px-4 rounded-md shadow-sm text-sm font-medium
                         text-white bg-[var(--primary-blue)] hover:bg-[var(--accent-yellow)]
                         focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--accent-yellow)]">
                    Iniciar sesión
                </button>
            </form>
